...
using MFramework.Common.Expressions;

namespace MFramework.Domain.Services.Repository.EF
{
    public static class EFRepositoryExtensions
    {
        public static IEFFetchingRepository<TEntity, TReleated> Fetch<TEntity, TReleated>(this IRepository<TEntity> repository, Expression<Func<TEntity, TReleated>> selector) where TEntity : Entity<TEntity>,new()
        {
        ...
        public static IEFFetchingRepository<TEntity, TReleated> FetchMany<TEntity, TReleated>(this IRepository<TEntity> repository, Expression<Func<TEntity, IEnumerable<TReleated>>> selector) where TEntity : Entity<TEntity>,new()
        {
            Guard.Against<ArgumentNullException>(repository == null, "Expected a non-null IRepository<> instance.");
        ...
        public static IEFFetchingRepository<TEntity, TReleated> ThenFetch<TEntity, TFetch, TReleated>(this IEFFetchingRepository<TEntity, TFetch> repository, Expression<Func<TFetch, TReleated>> selector) where TEntity : Entity<TEntity>, new()
        {
        ...
        public static IEFFetchingRepository<TEntity, TReleated> ThenFetchMany<TEntity, TFetch, TReleated>(this IEFFetchingRepository<TEntity, TFetch> repository, Expression<Func<TFetch, IEnumerable<TReleated>>> selector) where TEntity : Entity<TEntity>, new()
        {
            Guard.Against<ArgumentNullException>(repository == null, "Expected a non-null IEFFetchingRepository<> instance.");
